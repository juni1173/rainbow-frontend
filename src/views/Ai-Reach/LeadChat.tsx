        ...
        <Stack spacing={1.5}>
          <Box>
            ...
            <Typography variant="body2" color="#0D0D12">
              Hi Danielle, thank you for reaching out. First, please accept our
              sincere condolences if you are going through a loss right now. We
              are here to support you during this difficult time. Based on your
              chooses inquiry. You will choose : <br />
              <br /> <span style={{ fontWeight: "700" }}>Burial Services</span>
              <br />
              <br />
